    ...
    <section class="contact--info">
      <div class="contact--info__info">
        ...
        <div class="contact--info__phone">
          ...
          <p class="contact--info__phone--item3"> {{companyPhone}} </p>
          <p class="contact--info__phone--item4"> {{companyPhone2}} </p>
          <p class="contact--info__phone--item5"> Company Email: </p>
          <p class="contact--info__phone--item6"> {{companyEmail}} </p>
      ...
      <div class="contact--info__form">
            ...
            <div class="contact--info__formitem5">
                ...
                <p class="">
                    <textarea name="textarea" placeholder="Write your text here" rows="8" cols="80"></textarea>
                </p>
            </div>
